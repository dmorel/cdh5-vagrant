...
# replace only the first instance, there's a second one in the [ha] section
sed -i '0,/## resourcemanager_api_url=http:\/\/localhost:8088/s//resourcemanager_api_url=http:\/\/cdh-master:8088/' /etc/hue/conf.vagrant/hue.ini
