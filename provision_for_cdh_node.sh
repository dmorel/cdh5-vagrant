...
#alternatives --install /usr/bin/jar jar /usr/java/jdk1.8.0_121/bin/jar 20000
alternatives --install /usr/bin/javac javac /usr/java/jdk1.8.0_121/bin/javac 20000
alternatives --install /usr/bin/javaws javaws /usr/java/jdk1.8.0_121/jre/bin/javaws 20000
alternatives --set java /usr/java/jdk1.8.0_121/jre/bin/java
alternatives --set javaws /usr/java/jdk1.8.0_121/jre/bin/javaws
